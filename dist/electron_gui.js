...
class InputParser {
    static parse(input) {
        ...
        while (tokens.length > 0 && arrayhelper_1.ArrayHelper.includes(InputParser.ignoredTokens, tokens[0])) {
            tokens.shift();
        }
        if (tokens.length <= 0)
            return result;
        ...
        if (tokens.length > 0 && arrayhelper_1.ArrayHelper.includes(InputParser.prepositions, tokens[0])) {
